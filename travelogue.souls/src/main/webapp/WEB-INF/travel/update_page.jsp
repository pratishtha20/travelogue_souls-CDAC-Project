                    ...
                    <div class="col-md-8">
                        <div class="booking-page-left-form">
                          <div class="booking-form-heading padding-bottom">
                             <h3>Update Hotels Details</h3>
                          </div>
                            <form action="upd">
                                <div class="row">
                                    <div class="col-sm-6">
                                        HotelName<input type="text" name="name"  value="<d:out value="${ht_obj.name}"/>">
                                    </div>
                                    <div class="col-sm-6">
                                      Hotel Id:<input type="text" name="id" value="<d:out value="${ht_obj.id}"/>" readonly>
                                    </div>
                                </div>
                                   <div class="row">
                                    <div class="col-sm-6">
                                         Price:<input type="text" name="price"  value="<d:out value="${ht_obj.price}"/>">
                                    </div>
                                    <div class="col-sm-6">
                                      Package:<input type="text" name="package" value="<d:out value="${ht_obj.pack}"/>">
                                    </div>
                                </div>
                                   <div class="row">
                                    <div class="col-sm-6">
                                       Description:<input type="text" name="desc"  value="<d:out value="${ht_obj.description}"/>">
                                    </div>
                                      <div class="col-sm-6">
                                         Location:<input type="text" name="location" value="<d:out value="${ht_obj.location}"/>">
                                    </div>
                                </div>
                                 
                              
                               <center><input type="submit"></center>
                               <div align="center">${updt}</div>
                             </form>
                        </div>
                    </div>
                    <div class="col-md-4">
